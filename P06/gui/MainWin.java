...
public class MainWin extends JFrame implements ActionListener {
    ...
    public void onAboutClick() {
        ...
        JLabel title = new JLabel("<html>"
                + "<p><font size=+2>Mavs Ice Cream Emporium</font></p>"
                + "<p></p>"
                + "</html>");
        about.add(title);
        ...
        JLabel artists = new JLabel(
                "<html>"
                        ...
                        + "<p>Logo by Motty, licensed under CC BY-SA 3.0</p>"
                        + "<p><font size=-2>https://www.aa.com</font></p>"
    ...
    // protected void onButtonClick(int button) { // Select 1, 2, or 3 sticks from
    // pile
    // try {
    ...
    // computerPlayer.setBorder(computerPlayer.isSelected() ?
    // BorderFactory.createLineBorder(Color.black) : null);
    // }

    // protected void onRulesClick() { // Show the rules
    // String s = "The Rules of Nim\n\nCopyright 2017-2020 by George F. Rice - CC BY
    // 4.0\n\n" +
    // "The two players alternate taking 1 to 3 sticks from the pile.\n" +
    // "The goal is to force your opponent to take the last stick (called misère
    // rules).\n" +
    // "If the computer button is up, it's a two player game. If down, the computer
    // is always Player 2.)";
